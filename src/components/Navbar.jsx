                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <a href="#home" className="flex items-center gap-2.5 group">
                        <div className="relative">
                            <FaDumbbell className="text-accent text-2xl group-hover:rotate-12 transition-transform duration-500" />
                    ...
                    <button
                        ...
                        className="md:hidden text-white text-2xl p-2 hover:bg-white/5 rounded-lg transition-colors"
            ...
            <AnimatePresence>
                {mobileOpen && (
                    <motion.div
                        ...
                        className="md:hidden bg-dark/95 backdrop-blur-2xl border-t border-white/[0.04] overflow-hidden"
                    >
                        <div className="px-5 py-8 space-y-1">
                            {navLinks.map((link, i) => (
                                <motion.a
                                    ...
                                    className="block text-[15px] font-medium text-text-muted hover:text-accent transition-colors py-3 px-3 rounded-lg hover:bg-white/[0.03]"
                                >
                                    {link.name}
                                </motion.a>
                            ))}
                            <motion.a
                                ...
                                className="block text-center mt-6 px-6 py-3.5 bg-gradient-to-r from-accent to-red-700 text-white font-bold rounded-lg uppercase tracking-wider text-sm"
                            >
                                Join Now
                            </motion.a>
                        </div>
